...
ctx.lineWidth = fontSize / 20;
    ...
    bottomText.split('/n').reverse().forEach(function (t, i) {
...
function init () {
    ...
    topTextSizeInput = document.getElementById('top-size-text');
    bottomTextSizeInput = document.getElementById('bottom-size-text');
